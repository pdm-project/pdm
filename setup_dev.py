...
convention of setuptools but is basically a setuptools setup script.
...
def main():
    ...
    subprocess.check_call([venv_python.as_posix(), "-m", "pip", "install", "-U", "pip"])
    subprocess.check_call([venv_python.as_posix(), "-m", "pip", "install", "."])
