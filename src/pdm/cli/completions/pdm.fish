...
function __fish_pdm_41ba8a56174f8367_complete_no_subcommand
...
# global options
complete -c pdm -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -l config -d 'Specify another config file path [env var: PDM_CONFIG_FILE] '
complete -c pdm -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -l help -d 'Show this help message and exit.'
complete -c pdm -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -l ignore-python -d 'Ignore the Python path saved in .pdm-python. [env var: PDM_IGNORE_SAVED_PYTHON]'
complete -c pdm -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -l pep582 -d 'Print the command line to be eval\'d by the shell'
complete -c pdm -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -l quiet -d 'Suppress output'
complete -c pdm -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -l verbose -d 'Use `-v` for detailed output and `-vv` for more detailed'
complete -c pdm -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -l version -d 'Show the version and exit'

# commands
# add
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a add -d 'Add package(s) to pyproject.toml and install them'
...
# build
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a build -d 'Build artifacts for distribution'
...
# cache
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a cache -d 'Control the caches of PDM'
...
# completion
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a completion -d 'Generate completion scripts for the given shell'
complete -c pdm -A -n '__fish_seen_subcommand_from completion' -l help -d 'Show this help message and exit.'

# config
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a config -d 'Display the current configuration'
...
# fix
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a fix -d 'Fix the project problems according to the latest version of PDM'
...
# info
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a info -d 'Show the project information'
...
# init
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a init -d 'Initialize a pyproject.toml for PDM'
...
# install
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a install -d 'Install dependencies from lock file'
...
# list
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a list -d 'List packages installed in the current working set'
...
# plugin
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a plugin -d 'Manage the PDM program itself (previously known as plugin)'
...
# publish
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a publish -d 'Build and publish the project to PyPI'
...
# remove
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a remove -d 'Remove packages from pyproject.toml'
...
# run
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a run -d 'Run commands or scripts with local packages loaded'
...
# search
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a search -d 'Search for PyPI packages'
...
# self
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a self -d 'Manage the PDM program itself (previously known as plugin)'
...
# show
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a show -d 'Show the package information'
...
# sync
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a sync -d 'Synchronize the current working set with lock file'
...
# use
complete -c pdm -f -n '__fish_pdm_41ba8a56174f8367_complete_no_subcommand' -a use -d 'Use the given python version or path as base interpreter'
