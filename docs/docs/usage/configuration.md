...
| `pypi.url`                        | The URL of PyPI mirror                                                    | `https://pypi.org/simple`                                             | No                   | `PDM_PYPI_URL`            |
| `pypi.username`                   | The username to access PyPI                                               |                                                                       | No                   | `PDM_PYPI_USERNAME`       |
| `pypi.password`                   | The password to access PyPI                                               |                                                                       | No                   | `PDM_PYPI_PASSWORD`       |
| `pypi.ignore_stored_index`        | Ignore the configured indexes                                             | `False`                                                               | No                   | `PDM_IGNORE_STORED_INDEX` |
...
| `pypi.verify_ssl`                 | Verify SSL certificate when query PyPI                                    | `True`                                                                | No                   |                           |
| `pypi.json_api`                   | Consult PyPI's JSON API for package metadata                              | `False`                                                               | No                   | `PDM_PYPI_JSON_API`       |
