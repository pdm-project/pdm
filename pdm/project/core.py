...
class Project:
    ...
    def __init__(
        self, core: Core, root_path: os.PathLike | None, is_global: bool = False
    ) -> None:
    ...
    def get_locked_candidates(self, section: str | None = None) -> dict[str, Candidate]:
        if not self.lockfile_file.is_file():
            return {}
