...
_pdm_8820d2c61f1a916c_complete()
{
    ...
    if [[ ${cur} == --* ]] ; then
        ...
        case "$com" in
            ...
            (build)
            opts="--config-setting --dest --help --no-clean --no-sdist --no-wheel --project --verbose"
            ;;
...
complete -o default -F _pdm_8820d2c61f1a916c_complete pdm
